...
<head>
    ...
    <body>   
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 extra-small-screen display-table page-title-large">
                        <div class="display-table-cell vertical-align-middle text-center">
                            <!-- start page title -->
                            <h1 class="text-white alt-font font-weight-600 letter-spacing-minus-1 margin-15px-bottom">Contact us classic</h1>
                            <!-- end page title -->
                            <!-- start sub title -->
        ...
        <section id="contact" class="wow fadeIn no-padding bg-extra-dark-gray">
            <div class="container-fluid">
                <div class="row equalize sm-equalize-auto">
                    <div class="col-md-6 cover-background sm-height-450px xs-height-350px wow fadeIn" style="background: url(images/homepage-9-parallax-img6.jpg)"></div>
		...
		<iframe class="width-100 height-100 " src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3806.3906047868722!2d78.38403231415415!3d17.4410089880465!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb915f17a6ae85%3A0xd05d00cd0b7c33c4!2sGowra+Tulips%2C+Vittal+Rao+Nagar%2C+HITEC+City%2C+Hyderabad%2C+Telangana+500081!5e0!3m2!1sen!2sin!4v1550608405051" width="100%" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>
		</section>
        <!-- end map section -->
