...
<head>
    ...
    <body>
        ...
        <section class="no-padding one-third-screen position-relative wow fadeIn">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 display-table one-third-screen page-title-large">
                        <div class="display-table-cell vertical-align-middle text-center">
                            ...
                            <!-- end sub title -->
                            <!-- start page title -->
                            <h1 class="alt-font text-white font-weight-600 width-55 sm-width-80 xs-width-100 center-col no-margin-bottom">We are not your average brand agency</h1>
                            <!-- end page title -->
                        </div>
                    </div>
            ...
            <div class="swiper-auto-fade swiper-container z-index-minus2 position-absolute top-0 width-100 height-100">
                <div class="swiper-wrapper">
                    <!-- start slider item -->
                    <div class="swiper-slide cover-background one-third-screen" style="background-image:url('images/parallax-bg16.jpg');"></div>
                    <!-- end slider item -->
                    <!-- start slider item -->
                    <div class="swiper-slide cover-background one-third-screen" style="background-image:url('images/parallax-bg17.jpg');"></div>
                    <!-- end slider item -->
                    <!-- start slider item -->
                    <div class="swiper-slide cover-background one-third-screen" style="background-image:url('images/parallax-bg15.jpg');"></div>
                    <!-- end slider item -->
                </div>
            ...
            <div class="container">  
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 sm-text-center xs-margin-30px-bottom wow fadeInRight" data-wow-delay="0.2s">
                        ...
                        <div class="col-md-9 margin-5px-top last-paragraph-no-margin xs-no-padding-lr">
                    ...
                    <!-- end feature box item -->
                    <!-- start feature box item -->
                    <div class="col-md-4 col-sm-6 col-xs-12 sm-text-center wow fadeInRight" data-wow-delay="0.4s">
                        <div class="col-md-3 xs-no-padding">
        ...
        <section id="about" class="no-padding wow fadeIn">
            <div class="container-fluid">
                <div class="row equalize xs-equalize-auto">
                    <div class="col-lg-4 col-sm-6 col-xs-12 bg-extra-dark-gray wow fadeIn">              
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12 bg-extra-dark-gray display-table cover-background xs-height-400px wow fadeIn" style="background-image: url('images/about-img1.jpg')"></div>
                    <div class="col-lg-4 col-sm-12 col-xs-12 bg-extra-dark-gray display-table padding-six-all xs-padding-50px-tb xs-padding-15px-lr wow fadeIn">                        
                        <div class="display-table-cell vertical-align-middle">
                            <h5 class="alt-font text-white margin-35px-bottom xs-margin-15px-bottom">We provide high quality and cost effective offshore web services.</h5>
                            <!-- start progress-bar -->
        ...
        <section class="wow fadeIn">
            <div class="container">
                <div class="row">
                    <!-- start counter item -->
                    <div class="col-md-3 col-sm-6 col-xs-12 sm-margin-five-bottom sm-padding-ten-left xs-padding-15px-left xs-margin-30px-bottom text-center wow fadeInDown">
                        <h5 class="text-extra-dark-gray font-weight-600 no-margin timer  alt-font" data-speed="2000" data-to="350">350</h5>
                        <span class="display-block margin-three-bottom">Happy Clients</span>
                        <div class="separator-line-verticle-large bg-deep-pink display-inline-block"></div>
                    </div>
                    <!-- end counter item -->
                    <!-- start counter item -->
                    <div class="col-md-3 col-sm-6 col-xs-12 sm-margin-five-bottom sm-padding-ten-left xs-padding-15px-left xs-margin-30px-bottom text-center wow fadeInDown" data-wow-delay="0.2s">
                        <h5 class="text-extra-dark-gray font-weight-600 no-margin timer  alt-font" data-speed="2000" data-to="1500">1500</h5>
                        <span class="display-block margin-three-bottom">Photo Capture</span>
                        <div class="separator-line-verticle-large bg-deep-pink display-inline-block"></div>
                    </div>
                    <!-- end counter item -->
                    <!-- start counter item -->
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-margin-seven-bottom sm-padding-ten-left xs-padding-15px-left xs-margin-30px-bottom text-center  wow fadeInDown" data-wow-delay="0.4s">
                        <h5 class="text-extra-dark-gray font-weight-600 no-margin timer  alt-font" data-speed="2000" data-to="875">875</h5>
                        <span class="display-block margin-three-bottom">Work Completed</span>
                        <div class="separator-line-verticle-large bg-deep-pink display-inline-block"></div>
                    </div>
                    <!-- end counter item -->
                    <!-- start counter item -->
                    <div class="col-md-3 col-sm-6 col-xs-12 sm-padding-ten-left xs-padding-15px-left text-center wow fadeInDown" data-wow-delay="0.6s">
                        <h5 class="text-extra-dark-gray font-weight-600 no-margin timer  alt-font" data-speed="2000" data-to="984">984</h5>
                        <span class="display-block margin-three-bottom">Telephonic Talk</span>
                        <div class="separator-line-verticle-large bg-deep-pink display-inline-block"></div>
                    </div>
                    <!-- end counter item -->
                </div>
                ...
                <div class="row equalize">                   
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 sm-margin-four-bottom last-paragraph-no-margin xs-margin-30px-bottom wow fadeInUp">
                        <div class="bg-white text-center">
                            <a href="services-simple.html"><img src="images/latest-blog6.jpg" alt=""></a>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 sm-margin-four-bottom last-paragraph-no-margin xs-margin-30px-bottom wow fadeInUp" data-wow-delay="0.2s">
                        <div class="bg-white text-center">
                            <a href="services-simple.html"><img src="images/latest-blog5.jpg" alt=""></a>
                            <div class="padding-45px-all sm-padding-15px-all inner-match-height">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 sm-margin-four-bottom last-paragraph-no-margin xs-no-margin-bottom wow fadeInUp" data-wow-delay="0.4s">
                        <div class="bg-white text-center">
                            <a href="services-simple.html"><img src="images/latest-blog7.jpg" alt=""></a>
                            <div class="padding-45px-all sm-padding-15px-all inner-match-height">
        ...
        <!-- end feature box section -->
        <!-- start feature box section -->
        <section class="no-padding wow fadeIn xs-padding-30px-tb">
            <div class="container-fluid">
                <div class="row equalize feature-box-14">
                    <!-- start feature box item -->
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center display-table last-paragraph-no-margin wow fadeInRight no-padding">
                        <div class="display-table-cell vertical-align-middle padding-fifteen-all xs-padding-seven-all">
                            <h2 class="text-light-gray alt-font letter-spacing-minus-3 no-margin-bottom">01</h2>
                            <span class="display-block alt-font text-medium text-extra-dark-gray margin-15px-top margin-10px-bottom">Discussion of the Idea</span>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center display-table last-paragraph-no-margin wow fadeInRight no-padding" data-wow-delay="0.2s">
                        <div class="display-table-cell vertical-align-middle padding-fifteen-all xs-padding-seven-all">
                            <h2 class="text-light-gray alt-font letter-spacing-minus-3 no-margin-bottom">02</h2>
                            <span class="display-block alt-font text-medium text-extra-dark-gray margin-15px-top margin-10px-bottom">Elaboration of the Core</span>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard text.</p>
                        </div>
                    </div>
                    <!-- end feature box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center display-table last-paragraph-no-margin wow fadeInRight no-padding" data-wow-delay="0.4s">
                        <div class="display-table-cell vertical-align-middle padding-fifteen-all xs-padding-seven-all">
                            ...
                            <span class="display-block alt-font text-medium text-extra-dark-gray margin-15px-top margin-10px-bottom">Handcrafted Templates</span>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard text.</p>
                        </div>
                    </div>
                    <!-- end feature box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center display-table last-paragraph-no-margin wow fadeInRight no-padding" data-wow-delay="0.6s">
                        <div class="display-table-cell vertical-align-middle padding-fifteen-all xs-padding-seven-all">
                            ...
                            <span class="display-block alt-font text-medium text-extra-dark-gray margin-15px-top margin-10px-bottom">Testing for Perfection</span>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard text.</p>
                        </div>
                    </div>
                    <!-- end feature box -->
        ...
        <section class="parallax wow fadeIn" data-stellar-background-ratio="0.3" style="background-image:url('images/parallax-bg6.jpg');">
            <div class="opacity-extra-medium bg-black"></div>
            <div class="container position-relative">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-8 text-center center-col last-paragraph-no-margin">
                        <a href="https://www.youtube.com/watch?v=nrJtHemSPW4" class="popup-youtube"><img src="images/icon-play.png" class="width-130px" alt=""/></a>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12 xs-margin-30px-bottom">
                                <div class="display-table width-100 height-100">
                                    <div class="display-table-cell vertical-align-middle">
                                        <img src="images/about-img10.jpg" class="width-100" alt=""/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5 col-sm-6 col-xs-12 col-md-offset-1">
                                <div class="display-table width-100 height-100">
                                    <div class="display-table-cell vertical-align-middle">
                                        ...
                                        <a href="services-simple.html" class="btn btn-small btn-rounded btn-dark-gray">Explore services</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade in" id="tab_sec2">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12 xs-margin-30px-bottom">
                                <div class="display-table width-100 height-100">
                                    <div class="display-table-cell vertical-align-middle">
                                        <img src="images/about-img11.jpg" class="width-100" alt=""/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5 col-sm-6 col-xs-12 col-md-offset-1">
                    ...
                    <div class="tab-pane fade in" id="tab_sec3">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12 xs-margin-30px-bottom">
                                <div class="display-table width-100 height-100">
                                    <div class="display-table-cell vertical-align-middle">
                                        <img src="images/about-img12.jpg" class="width-100" alt=""/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5 col-sm-6 col-xs-12 col-md-offset-1">
                    ...
                    <div class="tab-pane fade in" id="tab_sec4">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12 xs-margin-30px-bottom">
                                <div class="display-table width-100 height-100">
                                    <div class="display-table-cell vertical-align-middle">
                                        <img src="images/about-img13.jpg" class="width-100" alt=""/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5 col-sm-6 col-xs-12 col-md-offset-1">
        ...
        <section class="parallax wow fadeIn" data-stellar-background-ratio="0.5" style="background-image: url('images/testimonial-parallax-img.jpg')">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="col-md-7 col-sm-10 col-xs-12 center-col equalize sm-equalize-auto">
                                    <div class="col-md-3 col-sm-3 col-xs-12 display-table">
                                        <div class="display-table-cell vertical-align-middle">
                                            <img src="images/avtar-07.jpg" alt="" class="border-radius-100 width-150px xs-width-100px xs-margin-15px-bottom">
                                        </div>
                                    </div>
                                    <div class="col-md-8 col-sm-8 col-xs-12 text-left xs-text-center margin-20px-left xs-no-margin-left display-table last-paragraph-no-margin">
                                        <div class="display-table-cell vertical-align-middle">
                                            ...
                                            <span class="text-white alt-font display-inline-block text-uppercase text-small margin-15px-top display-inline-block">- Jay Benjamin</span>
                                        </div>
                                    </div>
                                </div>
                            </div>  
                            ...
                            <div class="swiper-slide">
                                <div class="col-md-7 col-sm-10 col-xs-12 center-col equalize sm-equalize-auto">
                                    <div class="col-md-3 col-sm-3 col-xs-12 display-table">
                                        <div class="display-table-cell vertical-align-middle">
                                            <img src="images/avtar-08.jpg" alt="" class="border-radius-100 width-150px xs-width-100px xs-margin-15px-bottom">
                                        </div>
                                    </div>
                                    <div class="col-md-8 col-sm-8 col-xs-12 text-left xs-text-center margin-20px-left xs-no-margin-left display-table last-paragraph-no-margin">
                                        <div class="display-table-cell vertical-align-middle">
                                            <p class="text-extra-light-gray">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type.</p>
                                            <span class="text-white alt-font display-inline-block text-uppercase text-small margin-15px-top display-inline-block">- Herman Miller</span>
                                        </div>
                                    </div>
                                </div>
                            </div>   
                            ...
                            <div class="swiper-slide">
                                <div class="col-md-7 col-sm-10 col-xs-12 center-col equalize sm-equalize-auto">
                                    <div class="col-md-3 col-sm-3 col-xs-12 display-table">
                                        <div class="display-table-cell vertical-align-middle">
                                            <img src="images/avtar-09.jpg" alt="" class="border-radius-100 width-150px xs-width-100px xs-margin-15px-bottom">
                                        </div>
                                    </div>
                                    <div class="col-md-8 col-sm-8 col-xs-12 text-left xs-text-center margin-20px-left xs-no-margin-left display-table last-paragraph-no-margin">
                                        <div class="display-table-cell vertical-align-middle">
                                            <p class="text-extra-light-gray">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type.</p>
                                            <span class="text-white alt-font text-uppercase text-small margin-15px-top display-inline-block display-inline-block">- Hugh Macleod</span>
                                        </div>
                                    </div>
                                </div>
                            </div>   
        ...
        <section class="wow fadeIn">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12 center-col margin-eight-bottom sm-margin-40px-bottom xs-margin-30px-bottom text-center last-paragraph-no-margin">
                        <h5 class="alt-font font-weight-700 text-extra-dark-gray text-uppercase">Creative People</h5>
                        <p class="width-90 margin-lr-auto xs-width-100">A lot of young players don't really know much about the history of the game and a lot of them are missing out on what the game is all about, especially the whole concept of sportsmanship and teamwork.</p>
                    </div>  
                </div>
                <div class="row">
                    <!-- start team item -->
                    <div class="col-md-4 col-sm-4 col-xs-12 team-block text-left team-style-1 xs-margin-ten-bottom wow fadeInUp">
                        <figure>
                            <div class="team-image xs-width-100">
                                <img src="images/team19.jpg" alt="">
                                <div class="overlay-content text-center">
                                    <div class="display-table height-100 width-100">
                                        <div class="vertical-align-middle display-table-cell icon-social-small">
                                            <a href="http://facebook.com/" class="text-white text-white-hover" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                            <a href="http://twitter.com/" class="text-white text-white-hover" target="_blank"><i class="fab fa-twitter"></i></a>
                                            <a href="http://plus.google.com/" class="text-white text-white-hover" target="_blank"><i class="fab fa-google-plus-g"></i></a>
                                            <a href="http://instagram.com/" class="text-white text-white-hover" target="_blank"><i class="fab fa-instagram"></i></a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- end team item -->
                    <!-- start team item -->
                    <div class="col-md-4 col-sm-4 col-xs-12 team-block text-left team-style-1 xs-margin-ten-bottom wow fadeInUp" data-wow-delay="0.4s">
                        <figure>
                            <div class="team-image xs-width-100">
                                <img src="images/team21.jpg" alt="">
                                <div class="overlay-content text-center">
                                    <div class="display-table height-100 width-100">
                                        <div class="vertical-align-middle display-table-cell icon-social-small">
                                            <a href="http://facebook.com/" class="text-white text-white-hover" target="_blank"><i class="fab fa-facebook-f"></i></a>
        ...
        <section class="bg-light-gray">
            <div class="container-fluid padding-five-lr">
                <div class="row">
                    <!-- start clients slide item --><div class="col-md-2 col-sm-6 text-center wow fadeInRight"><a href="https://envato.com/" target="_blank"><img src="images/logo-1.png" alt=""/></a></div><!-- end clients item -->
                    <!-- start clients slide item --><div class="col-md-2 col-sm-6 text-center wow fadeInRight" data-wow-delay="0.2s"><a href="https://woocommerce.com/" target="_blank"><img src="images/logo-2.png" alt=""/></a></div><!-- end clients slide item -->
                    <!-- start clients slide item --><div class="col-md-2 col-sm-6 text-center wow fadeInRight" data-wow-delay="0.4s"><a href="https://wordpress.com/" target="_blank"><img src="images/logo-3.png" alt=""/></a></div><!-- end clients slide item -->
                    <!-- start clients slide item --><div class="col-md-2 col-sm-6 text-center wow fadeInRight" data-wow-delay="0.6s"><a href="https://magento.com/" target="_blank"><img src="images/logo-4.png" alt=""/></a></div><!-- end clients slide item -->
                    <!-- start clients slide item --><div class="col-md-2 col-sm-6 text-center wow fadeInRight" data-wow-delay="0.8s"><a href="https://www.pingdom.com/" target="_blank"><img src="images/logo-6.png" alt=""/></a></div><!-- end clients slide item -->
                    <!-- start clients slide item --><div class="col-md-2 col-sm-6 text-center wow fadeInRight" data-wow-delay="1s"><a href="https://www.google.com/" target="_blank"><img src="images/logo-17.png" alt=""/></a></div><!-- end clients slide item -->
                </div>
            </div>
        </section>
